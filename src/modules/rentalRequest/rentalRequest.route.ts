...
router.get("/:rentalRequestId", auth(UserRole.LANDLORD, UserRole.TENANT), validateRequest(RentalRequestValidation.getRentalRequestByIdSchema), rentalRequestController.getRentalRequestById);
router.patch("/:rentalRequestId/cancel", auth(UserRole.TENANT), validateRequest(RentalRequestValidation.cancelRentalRequestSchema), rentalRequestController.cancelRentalRequest);
